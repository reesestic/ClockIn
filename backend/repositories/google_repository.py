...
load_dotenv()
# Support both naming conventions across env files
GOOGLE_CLIENT_ID = (
    os.getenv("GOOGLE_CLIENT_ID")
    or os.getenv("GOOGLE_CAL_CLIENT_ID")
    or os.getenv("GOOGLE_OAUTH_CLIENT_ID")
)
GOOGLE_CLIENT_SECRET = (
    os.getenv("GOOGLE_CLIENT_SECRET")
    or os.getenv("GOOGLE_CAL_CLIENT_SECRET")
    or os.getenv("GOOGLE_OAUTH_CLIENT_SECRET")
)
# Must match the URI registered in Google Cloud Console
GOOGLE_REDIRECT_URI = (
    os.getenv("GOOGLE_REDIRECT_URI")
    or "http://localhost:8000/api/google/callback"
)
