...
export default function ScheduleView({ schedule, onGenerate, onEdit, onDoneEditing, onBlocksChange, isLocked, calendarMode, onSetCalendarMode, hasGoogleCalendar, onCalendarBlockToggle }: ScheduleViewProps) {
