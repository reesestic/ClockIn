...
1. First, clone this repo. Navigate to the root of where you would like your file created and git clone the URL of this repo. After cloning the repo locally, you will have the backend and frontend files needed for development, along with the needed requirements file.
To set up the frontend after cloning, run `npm install`. This installs the node_modules that are not uploaded to Github that are required for functionality.
